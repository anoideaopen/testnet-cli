...
echo "==================  acl addUser  ================================="
echo "=================================================================="
./cli invoke acl addUser $validatorPublicKey1 123 testuser true | true
./cli invoke acl addUser $validatorPublicKey2 123 testuser true | true
./cli invoke acl addUser $validatorPublicKey3 123 testuser true | true
...
./cli sendRequest acl addMultisig $validatorPublicKeys
